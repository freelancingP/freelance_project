    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('veg_nonveg_egg', models.CharField(choices=[('Vegetarian', 'Vegetarian'), ('Non Vegetarian', 'Non Vegetarian'), ('Eggitarian', 'Eggitarian'), ('Pescetarian', 'Pescetarian'), ('Poultry', 'Poultry'), ('Vegan', 'Vegan')], max_length=30)),
